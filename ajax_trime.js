const mostrar = () =>{
    ...
    xhttp.open('GET', 'trimeres2.json', true);
    ...
    xhttp.onreadystatechange = function () {
        ...
        if(this.readyState == 4 && this.status == 200){
            ...
            datos.forEach(dato => {
                ...
                info3.innerHTML = parseFloat(dato['general']);

                info4.innerHTML = parseFloat(dato['dificultad']);

                info5.innerHTML = parseFloat(dato['recomendacion'].match("[0-9]+"));
